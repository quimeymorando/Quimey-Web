                ...
                <div className="absolute inset-0 z-0 opacity-100 pointer-events-none overflow-hidden">
                    {isMobile ? (
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] opacity-30">
                            <div className="absolute inset-0 border-[1px] border-brand-cyan/40 rounded-full" />
                            <div className="absolute inset-[15%] border-[1px] border-dashed border-brand-purple/40 rounded-full" />
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-brand-cyan/10 blur-3xl rounded-full" />
                        </div>
                    ) : (
